...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-768-erd-s-problem-768-8519b54f-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-768"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-768-erd-s-problem-768-8519b54f-v1",
      "problem_contract_sha256": "b0f9020c8eaa9995be59cb87e2db9f24890ee7dd7b6de8fa60898696d626cb7a",
      "problem_id": "problem:um-ep-768-erd-s-problem-768-8519b54f",
      "route_id": "route:um-ep-768-erd-s-problem-768-8519b54f-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-768-erd-s-problem-768-8519b54f-source-fidelity-01",
      "graph_id": "graph:um-ep-768-erd-s-problem-768-8519b54f-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-768-erd-s-problem-768-8519b54f-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-768-erd-s-problem-768-8519b54f-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A\\subset\\mathbb{N}$ be the set of $n$ such that for every prime $p\\mid n$ there exists some $d\\mid n$ with $d>1$ such that $d\\equiv 1\\pmod{p}$. Is it true that there exists some constant $c>0$ such that for all large $N$ $ \\frac{\\lvert A\\cap [1,N]\\rvert}{N}=\\exp(-(c+o(1))\\sqrt{\\log N}\\log\\log N). $"
          },
          "statement_sha256": "5e927b2c810eabbb60527b26bd83a04bfe9e15bc7229853e33a451b00318927e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-768-erd-s-problem-768-8519b54f-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-768-erd-s-problem-768-8519b54f-root",
      "route_id": "route:um-ep-768-erd-s-problem-768-8519b54f-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-768-99ec210738a3",
        "url": "https://www.unsolvedmath.com/problems/EP-768"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
